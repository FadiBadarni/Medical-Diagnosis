...
class DiagnosisTest {
    ...
    void setResults() {
        ...
        Patient p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522, "Male", 0, 0);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522, "female", 0, 0);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 16, 123, 23, 586535522, "female", 0, 0);
        values=diagnosis.setResults(p,5500,70,12,5,40,33,0.7,70,30,70,17);
        assertEquals(values.get("WBC"),0);
        assertEquals(values.get("Neut"),1);
        assertEquals(values.get("HCT"),0);

        p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522, "female", 1, 0);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522, "female", 0, 1);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522,  "male", 1, 1);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 3, 123, 23, 586535522, "male", 1, 1);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 60, 123, 23, 586535522,"male", 1, 1);
    ...
    void setWBCLevel() {
        Diagnosis diagnosis = new Diagnosis();
        Patient p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522,  "Male", 1, 1);
       assertEquals(diagnosis.setWBCLevel(p,4500),0);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 18, 123, 23, 586535522, "Male", 1, 1);
        assertEquals(diagnosis.setWBCLevel(p,4500),0);
        assertEquals(diagnosis.setWBCLevel(p,5000),0);
        assertEquals(diagnosis.setWBCLevel(p,11000),0);
        assertEquals(diagnosis.setWBCLevel(p,3000),-1);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 17, 123, 23, 586535522, "Male", 1, 1);
        ...
        p = new Patient(123456789, "FirstName", "LastName", 4, 123, 23, 586535522, "Male", 1, 1);
        assertEquals(diagnosis.setWBCLevel(p,5500),0);
        assertEquals(diagnosis.setWBCLevel(p,15500),0);
        assertEquals(diagnosis.setWBCLevel(p,11000),0);
        assertEquals(diagnosis.setWBCLevel(p,5000),-1);
    ...
    void setHbLevel() {
        ...
        assertEquals(diagnosis.setHbLevel(p, 17.6), 0);
         p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522,  "Female", 1, 1);
        assertEquals(diagnosis.setHbLevel(p, 11), -1);
        assertEquals(diagnosis.setHbLevel(p, 12), 0);
        assertEquals(diagnosis.setHbLevel(p, 16), 0);
        ...
        assertEquals(diagnosis.setHbLevel(p, 19), 1);
        p = new Patient(123456789, "FirstName", "LastName", 16, 123, 23, 586535522, "Female", 1, 1);
        assertEquals(diagnosis.setHbLevel(p, 11), -1);
    ...
    void setApLevel() {
       ...
       p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522,"Male", 0, 1);
    ...
    void setHdlLevel() {
        Diagnosis diagnosis = new Diagnosis();
        Patient p = new Patient(123456789, "FirstName", "LastName", 20, 123, 23, 586535522, "Male", 1, 0);
    ...
    void setCreatinineLevel() {
        ...
        Diagnosis diagnosis = new Diagnosis();
        //60+
        Patient p = new Patient(123456789, "FirstName", "LastName", 60, 123, 23, 586535522, "Male", 1, 0);
        ...
        //18-59
        //59
         p = new Patient(123456789, "FirstName", "LastName", 59, 123, 23, 586535522, "Male", 1, 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.6), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 1), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.7), 0);
        ...
        //18
        p = new Patient(123456789, "FirstName", "LastName", 18, 123, 23, 586535522, "Male", 1, 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.6), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 1), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.7), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.9), 0);
        ...
        //3-17
        //17
        p = new Patient(123456789, "FirstName", "LastName", 17, 123, 23, 586535522, "Male", 1, 0);
        ...
        assertEquals(diagnosis.setCreatinineLevel(p, 1.25), 1);
        //3
        p = new Patient(123456789, "FirstName", "LastName", 3, 123, 23, 586535522, "Male", 1, 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.5), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 1), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.7), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.9), 0);
        ...
        //0-2
        //2
        p = new Patient(123456789, "FirstName", "LastName", 2, 123, 23, 586535522, "Male", 1, 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.5), 0);
        ...
        //2
        p = new Patient(123456789, "FirstName", "LastName", 0, 123, 23, 586535522,  "Male", 1, 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.5), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.2), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.4), 0);
        assertEquals(diagnosis.setCreatinineLevel(p, 0.49), 0);
    ...
    void setUreaLevel() {
        ...
        // not Eastern
         p = new Patient(123456789, "FirstName", "LastName", 60, 123, 23, 586535522,  "Male", 0, 0);
        assertEquals(diagnosis.setUreaLevel(p, 18.7), 0);
    ...
    void setHctLevel() {
        ...
        //female
        p = new Patient(123456789, "FirstName", "LastName", 60, 123, 23, 586535522,"female", 1, 0);
