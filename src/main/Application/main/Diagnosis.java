...
public class Diagnosis implements Initializable {
    ...
    private void setResults(Patient p, double WBC_Level, double neut_Level, double lymph_Level, double RBC_Level,
        ...
        setNeutLevel(neut_Level);
        setLymphLevel(lymph_Level);
    ...
    private void setLymphLevel(double lymph_level) {
        if (lymph_level < 36) {
    ...
    private void setNeutLevel(double Neut_Level) {
        if (Neut_Level < 28) {
    ...
    private void WBC_OverFlow() {
        ...
        testField1.setText("NEUT OVERFLOW");
        values.put("WBC", 1);
    }
